 ...
 */
package oop.e18.assignments.modules.Modul008;
 ...
 * @author Oliver
 */
public class Modul008 extends Modul //The 'extends Modul' means that it is a child
{
    public Modul008(boolean active) // The constructer - means that it requires a boolean when created to control if it is active
    {
        super(active);
    }
